...
<body>
    ...
    <?php
        ...
        <?php
            ...
            $productImage = 'productImages/' . $row['product_image'];
            $productInStock = $row['product_inStock'];
            $productStatus = $row['product_status'];
            $productUpdateDate = $row['product_update_date'];

            $productInventoryClass = '';
            if ($productInStock < 10) {
                $productInventoryClass = 'productLowInventory';
            }

            $productStatusClass = '';
            if (!empty($productStatus)) {
                $productStatusClass = 'productStatus';
            }
    ?>
        <div class="productBlock">
            ...
            <div class="productDetails">
                ...
                <p class="productInventory <?php echo $productInventoryClass; ?>">In stock:
                    <?php echo $productInStock; ?>
                </p>
                <?php if (!empty($productStatus)):  ?>
                <p class="<?php echo $productStatusClass; ?>">
